...
class Particle:
    ...
    def sampleCovidState(self):   
        return "Infected" if np.random.uniform(low=0.0, high=1.0) < 0.05 else "Susceptible"
...
if __name__ == '__main__':
    particleTest = Particle(1, 1, 1, 1, 5)
    print(particleTest.covidState)
    print(particleTest.susceptibility)
    #nparticles = 50
