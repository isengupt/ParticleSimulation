...
class World:
    ...
    def update(self, i, l1, l2 ):
        print(i)
        l1.set_data(self.curTime, self.compartmentStats['infected'])
        print(self.compartmentStats['recovered'])
        l2.set_data(self.curTime, self.compartmentStats['recovered'])
        self.curTime += 1
    ...
    def do_animation(self, save=False):
        ...
        fig =  plt.figure()
        self.ax = fig.add_subplot(2,2,2)
        self.ax_line = fig.add_subplot(1,2,1)
        l1, = self.ax_line.plot([], [], 'r-')
        l2, = self.ax_line.plot([], [], 'g-')
        ...
        ani = animation.FuncAnimation(fig, self.update, fargs=(l1,l2),
